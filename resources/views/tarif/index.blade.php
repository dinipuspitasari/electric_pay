...
@section('title', 'Listrik Praktis | Tarif')
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-900 px-10 ">
                <thead class="text-xs text-white uppercase bg-gray-900 h-8">
                    <tr align="center">
                        ...
                        <th class="border border-gray-300 px-2 py-2">Tarif / kwh</th>
                        <th class="border border-gray-300 px-2 py-2">Terakhir Di update</th>
                ...
                <tbody>
                    @foreach ($tarif as $u)
                        <tr align="center" class="bg-white border-b text-gray-900">
                            ...
                            <td class="border border-gray-300 px-2 py-2">{{ $u->daya }}</td>
                            <td class="border border-gray-300 px-2 py-2">Rp. {{ $u->tarifperkwh }}</td>
                            <td class="border border-gray-300 px-2 py-2">{{ $u->updated_at }}</td>
                            <td class="flex items-center justify-center py-1">
                                <a href={{ url('/tarif/edit/' . $u->id) }} type="button"
