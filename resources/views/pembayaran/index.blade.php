...
@section('content')
    ...
    <div class="col">
        <h2 class="mt-2 text-xl mb-1 font-semibold"> Data Pembayaran</h2>
        <hr>
    </div>
            ...
            <tbody>
                @foreach ($tagihan as $u)
                    <tr align="center" class="bg-white border-b text-gray-900">
                        ...
                        <td class="border border-gray-300 px-2 py-2">{{ $u->pelanggan->tarif->daya }}</td>
                        ...
                        <td class="flex items-center justify-center py-2 px-2">
                            <a href={{ url('/pembayaran/details/' . $u->id) }} type="button"
